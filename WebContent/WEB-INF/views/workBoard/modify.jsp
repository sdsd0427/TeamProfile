	  		...
	  		<div class="row md-2">
	  			...
	  			<div class="col-sm-6">
			        ...
			        <li class="breadcrumb-item">
			        	<a href="list.do">
				        	<i class="fa fa-dashboard"></i>취업정보방
				        </a>
			        </li>
					...
					<div class="card-body">
						<form role="form" method="post" action="modify.do" name="modifyForm">
							...
							<div class="form-group">
								...
								<input type="text" id="title" name='title' class="form-control" value="${workBoard.title }">
							</div>
							<div class="form-group">
								<label for="writer">작성자</label> 
								<input type="text" id="writer" readonly	name="writer" class="form-control"  value="${workBoard.writer }">
							</div>
							<div class="form-group">
								<label for="content">내 용</label>		
								<textarea class="form-control" name="content" id="content" rows="3"
									placeholder="500자 내외로 작성하세요.">${fn:escapeXml(workBoard.content) }</textarea>						
							</div>
						</form>
					</div><!--end card-body  -->
