					...
					<div class="card-body">
						<form role="form" method="post" action="modify.do" name="modifyForm">
							...
							<div class="form-group">
								...
								<input type="text" id="title" name='title' class="form-control" value="${freeBoard.title }">
							</div>
							<div class="form-group">
								<label for="writer">작성자</label> 
								<input type="text" id="writer" readonly	name="id" class="form-control"  value="${freeBoard.id }">
							</div>
							<div class="form-group">
								<label for="content">내 용</label>		
								<textarea class="form-control" name="content" id="content" rows="3"
									placeholder="500자 내외로 작성하세요.">${fn:escapeXml(freeBoard.content) }</textarea>						
							</div>
						</form>
					</div><!--end card-body  -->
